...
public class LeshanClientDemo2 {
    ...
    private final static String[] modelPaths = new String[] { "3303.xml","3313.xml","fwupdate.xml"};

    private static final int OBJECT_ID_TEMPERATURE_SENSOR = 3303;
    private static final int OBJECT_ID_ACCELEROMETER = 3313;
    private static final int OBJECT_ID_FWUPDATE = 5;
    private final static String DEFAULT_ENDPOINT = "LeshanClientDemo2";
    private final static int DEFAULT_LIFETIME = 5 * 60; // 5min in seconds
    private final static String USAGE = "java -jar leshan-client-demo2.jar [OPTION]\n\n";
...
//        initializer.setInstancesForObject(OBJECT_ID_ACCELEROMETER, new RandomAccelerometerSensor());
        initializer.setInstancesForObject(FIRMWARE, new FirmUpdater(),new FirmUpdater(),new FirmUpdater());
